...
# Load up alm and blm
cls = np.loadtxt('../aux/wmap7_r0p03_lensed_uK_ext.txt', unpack=True) # Cl in uK^2
ell, cls = cls[0], cls[1:]
...
print 'calculating spin-maps'
b2.get_spinmaps(alm, blm, mmax) 
print 'stored spin-maps'
...
for cidx, chunk in enumerate(chunks):
    print 'working on chunk {:03}'.format(cidx), chunk
