...
res_mono = minimize(penalty_monoref, x_mono, method='BFGS', jac=grad_penalty_monoref, options={'disp':True})
print('Indices, Thicknesses(mm)', res_mono.x)
...
x3 = [1.5, 2, 2.5, .3,.3,.3]
res5 = minimize(penalty5, x3, method='BFGS', jac=grad_penalty5, options={'disp':True})
